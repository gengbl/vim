...
"set makeprg="C:\Program Files (x86)\Microsoft Visual Studio 10.0\VC\bin\nmake.exe"
"  CompilerSet makeprg=nmake.exe\ -l\ %
...
" disable auto complete at type some char
...
au FileType c,cpp,h setl shiftwidth=4
au FileType c,cpp,h setl tabstop=4
